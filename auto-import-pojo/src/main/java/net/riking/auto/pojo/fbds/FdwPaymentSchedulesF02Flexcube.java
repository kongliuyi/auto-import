 ...
 */
@Entity
@Table(name = "FDW_PaymentSchedules_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_PaymentSchedules_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwPaymentSchedulesF02Flexcube implements Serializable {
