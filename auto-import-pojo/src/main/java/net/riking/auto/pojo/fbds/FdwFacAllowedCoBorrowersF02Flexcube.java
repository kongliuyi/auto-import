 ...
 */
@Entity
@Table(name = "FDW_FacAllowedCoBorrowers_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_FacAllowedCoBorrowers_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwFacAllowedCoBorrowersF02Flexcube implements Serializable {
    ...
    private String coBorAlternateSourceRelId;
