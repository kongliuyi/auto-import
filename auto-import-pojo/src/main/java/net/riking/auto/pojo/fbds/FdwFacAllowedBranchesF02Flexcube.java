 ...
 */
@Entity
@Table(name = "FDW_FacAllowedBranches_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_FacAllowedBranches_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwFacAllowedBranchesF02Flexcube implements Serializable {
