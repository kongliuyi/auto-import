 ...
 * @Description
 * @Author kongLiuYi
 * @Date 2020/3/2 0002 15:15
 */
@Entity

@Table(name = "AEG_FacAEG_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "AEG_FacAEG_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class AegFacAegF02Flexcube implements Serializable {
