 ...
 */
@Entity
@Table(name = "FDW_FacFeesInterestRatesSchedules_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_FacFeesInterestRatesSchedules_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwFacFeesInterestRatesSchedulesF02Flexcube implements Serializable {
