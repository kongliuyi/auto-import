 ...
 */
@Entity
@Table(name = "FDW_Cashflows_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_Cashflows_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwCashflowsF02Flexcube implements Serializable {
    ...
    private String cashFlowIndicator;
