 ...
 */
@Entity
@Table(name = "FDW_FacAlternates_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_FacAlternates_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwFacAlternatesF02Flexcube implements Serializable {
    ...
    private String altSourceSysCode;
    private String alternateFacilityId;
