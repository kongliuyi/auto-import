 ...
 */
@Entity
@Table(name = "FDW_FacFeesTrades_F02_FLEXCUBE")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SourceFile(value = "FDW_FacFeesTrades_F02_FLEXCUBE", type = FileType.TXT_DELIMITER, delimiter = "|", head = 3)
public class FdwFacFeesTradesF02Flexcube implements Serializable {
